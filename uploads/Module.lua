...
local Themes = {
	Light = {
		...
		MinimiseAccent = Color3.fromRGB(35, 154, 170),
    ...
    Real = {
		...
		Minimise = Color3.fromRGB(5, 182, 167),
		MinimiseAccent = Color3.fromRGB(147,59,0),
		Maximise = Color3.fromRGB(16, 13, 206),
		MaximiseAccent = Color3.fromRGB(143, 81, 10),
		NavBar = Color3.fromRGB(2),
        NavBarAccent = Color3.fromRGB(255,255,255),
		NavBarInvert = Color3.fromRGB(235,235,235),
		TitleBar = Color3.fromRGB(191, 13, 197),
		TitleBarAccent = Color3.fromRGB(129, 11, 129),
		Overlay = Color3.fromRGB(90, 89, 80),
		...
		ButtonAccent = Color3.fromRGB(20,30,90),
		ChipSet = Color3.fromRGB(235,235,235),
		ChipSetAccent = Color3.fromRGB(78, 15, 15),
		DataTable = Color3.fromRGB(23, 33, 167),
		DataTableAccent = Color3.fromRGB(85,85,85),
		Slider = Color3.fromRGB(97, 57, 57),
		...
		ColorPickerAccent = Color3.fromRGB(81, 30, 148),
		TextField = Color3.fromRGB(148, 90, 52),
		TextFieldAccent = Color3.fromRGB(148, 90, 52),
